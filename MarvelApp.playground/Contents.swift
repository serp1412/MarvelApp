 ...
 * A lot of curious extensions were added to improve the workflow, look and readability of code. You can find most of them in the `MarvelAppFramework`>`Helpers` folder. Most of them from the project I'm currently working on, so can't give out specific sources ¯\_(ツ)_/¯
